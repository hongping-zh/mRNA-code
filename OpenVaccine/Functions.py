...
def get_best_weights_from_fold(fold,top=0):#top=5
...
def mutate_rna_input(sequence,nmute=.15):
    ...
    sequence_mutation= sequence_mutation.int()
    structure_mutation=torch.randint(4,7,size=(sequence.size(0),nmute))
    structure_mutation = structure_mutation.int()
    d_mutation=torch.randint(7,14,size=(sequence.size(0),nmute))
    d_mutation = d_mutation.int()
    mutated=sequence.clone()
    # print("mutated:",type(mutated),mutated)
    # print("sequence_mutation:", type(sequence_mutation),sequence_mutation)
    # print("structure_mutation:", type(structure_mutation),structure_mutation)
    # print("d_mutation:", type(d_mutation),d_mutation)
