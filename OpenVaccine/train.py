...
def get_args():
    ...
    parser.add_argument('--path', type=str, default=r'D:\DAQIU\DLGP\SecretJob\190.RNAdegformer-Webapp-main\stanford-covid-vaccine', required=False,help='path of csv file with DNA sequences and labels')
